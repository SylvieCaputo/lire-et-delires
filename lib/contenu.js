...
export const articles = [
  {
    ...
    titre: "Et bien sûr et avant tout, il y a Cent ans de solitude.",
    image: "/couvertures/cent-ans-de-solitude.png",
    extrait:
      "Bien plus puissant qu'un chef d'œuvre absolu : une vision du monde, une reformulation grandiose du réel.",
    date: "2026-07-23",
    contenu: [
